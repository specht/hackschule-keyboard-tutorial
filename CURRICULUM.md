# Hackschule Keyboard Tutorial – Curriculum
...
- Das Kreuz im Tab zum Schließen einer gespeicherten Datei verstehen

## 5. Suchen und Ersetzen

- Mit Strg+F in der aktuellen Datei suchen
...
- Alle Treffer mit Strg+Alt+Enter ersetzen
- Suchen, ersetzen, kontrollieren und speichern kombinieren
...
- Mehrere Cursor gemeinsam bewegen
- An mehreren Zeilen gleichzeitig Text einfügen
- Einen wiederkehrenden Namen an allen Stellen gemeinsam ändern
...
- Einen Ruby-Block zwischen `do` und `end` verschieben
